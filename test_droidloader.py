...
def testGetPermissions():
    ...
    print(f"[+] {successful} permissions are correct compared to Androguard") 
...
def testGetClasses():
    ...
    print(f"[+] 10 samples tested")
    print(f"[+] {equalSuccessful} classes are correct compared to Androguard") 
    print(f"[+] {containsSuccessful} classes contains classes from Androguard") 
